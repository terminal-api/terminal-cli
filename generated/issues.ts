...
export async function list_issues(client: TerminalClient, args: Record<string, unknown>): Promise<unknown> {
  return await client.get("/issues", {
...
export async function resolve_issue(client: TerminalClient, args: Record<string, unknown>): Promise<unknown> {
