...
export async function list_vehicles(client: TerminalClient, args: Record<string, unknown>): Promise<unknown> {
...
export async function get_vehicle(client: TerminalClient, args: Record<string, unknown>): Promise<unknown> {
  return await client.get(`/vehicles/${args["id"]}`, {
      "raw": args["raw"] as string | number | boolean | undefined,
      "expand": args["expand"] as string | number | boolean | undefined
    }, true);
}

export async function list_latest_vehicle_locations(client: TerminalClient, args: Record<string, unknown>): Promise<unknown> {
  return await client.get("/vehicles/locations", {
      "cursor": args["cursor"] as string | number | boolean | undefined,
      "limit": args["limit"] as string | number | boolean | undefined,
      "raw": args["raw"] as string | number | boolean | undefined,
...
export async function list_historical_vehicle_locations(client: TerminalClient, args: Record<string, unknown>): Promise<unknown> {
  return await client.get(`/vehicles/${args["vehicleId"]}/locations`, {
      "cursor": args["cursor"] as string | number | boolean | undefined,
      "limit": args["limit"] as string | number | boolean | undefined,
...
export async function list_historical_vehicle_stats(client: TerminalClient, args: Record<string, unknown>): Promise<unknown> {
  return await client.get(`/vehicles/${args["vehicleId"]}/stats/historical`, {
      "cursor": args["cursor"] as string | number | boolean | undefined,
      "limit": args["limit"] as string | number | boolean | undefined,
      "expand": args["expand"] as string | number | boolean | undefined,
      "startAt": args["startAt"] as string | number | boolean | undefined,
