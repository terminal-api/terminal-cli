...
export async function list_safety_events(client: TerminalClient, args: Record<string, unknown>): Promise<unknown> {
...
export async function get_safety_event(client: TerminalClient, args: Record<string, unknown>): Promise<unknown> {
  return await client.get(`/safety/events/${args["id"]}`, {
      "expand": args["expand"] as string | number | boolean | undefined,
      "raw": args["raw"] as string | number | boolean | undefined
    }, true);
}

export async function get_event_camera_media(client: TerminalClient, args: Record<string, unknown>): Promise<unknown> {
  return await client.get(`/safety/events/${args["id"]}/camera-media`, {
      "raw": args["raw"] as string | number | boolean | undefined
    }, true);
}
