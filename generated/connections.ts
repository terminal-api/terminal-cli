...
export async function list_connections(
  ...
  return await client.get(
    "/connections",
    {
      ...
      order: args["order"] as string | number | boolean | undefined,
    },
    false,
  );
}
...
export async function delete_current_connection(
  client: TerminalClient,
  _args: Record<string, unknown>,
): Promise<unknown> {
  return await client.delete("/connections/current", undefined, true);
}
...
export const commands: Command[] = [
  {
    ...
    args: [
      ...
      },
      {
        ...
        enum: ["connected", "disconnected", "archived", "pending_deletion", "deleting", "deleted"],
      },
      {
        name: "provider",
        type: "string",
  ...
  {
    name: "delete-current-connection",
    description: "Delete Current Connection",
    method: "DELETE",
    path: "/connections/current",
    requiresConnectionToken: true,
    args: [],
    handler: delete_current_connection,
    responseSchema: null,
  },
];
