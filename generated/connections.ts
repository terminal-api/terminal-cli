...
export async function list_connections(client: TerminalClient, args: Record<string, unknown>): Promise<unknown> {
...
export async function get_current_connection(client: TerminalClient, _args: Record<string, unknown>): Promise<unknown> {
  return await client.get("/connections/current", undefined, true);
}

export async function update_current_connection(client: TerminalClient, args: Record<string, unknown>): Promise<unknown> {
  return await client.patch("/connections/current", {
      "status": args["status"],
...
export const commands: Command[] = [
  ...
  },
  {
    ...
    },
    {
      ...
      type: "string",
      required: false,
      description: "Enum values: - `automatic`: Terminal will keep this connections data up to date - `manual`: Terminal will only sync data upon request",
